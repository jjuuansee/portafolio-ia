...
<style>
/* Algoritmos Avanzados Index Styles */
.course-hero {
...
<div class="course-hero">
  <h1>Algoritmos Avanzados</h1>
  <p>
    Bienvenido a mi portafolio de <strong>Algoritmos Avanzados de Búsqueda y Optimización</strong>. 
...
<a href="ejercicios/" class="section-card">
  ...
  <p class="section-card-description">
    ...
    Incluye ejercicios de programación dinámica, algoritmos de ramificación y poda, y optimización.
  </p>
...
<a href="teoria/" class="section-card">
  ...
  <p class="section-card-description">
    ...
    Documentación sobre algoritmos de búsqueda, grafos, programación dinámica y optimización.
  </p>
  <span class="section-card-link">
    Ver teoría
    <svg viewBox="0 0 24 24" fill="currentColor">
